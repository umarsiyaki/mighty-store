document.addEventListener('DOMContentLoaded', function() {
   ...
   // Salse & Revenue Chart
    ...
    // Additional admin dashboard functionalities
    ...
    const countDivideBtn = document.getElementById('count-divide-btn');
    ...
    countMultiplyBtn.addEventListener('click', () => {
        ...
        quantity.value = count * 2;
    });

    countDivideBtn.addEventListener('click', () => {
        const count = parseInt(quantity.value) || 1;
        if (count > 1) {
            quantity.value = count / 2;
        }
